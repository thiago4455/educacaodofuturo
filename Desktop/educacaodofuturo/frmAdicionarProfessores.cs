...
{
    public partial class frmAdicionarProfessores : Form
    {
        ...
        public frmAdicionarProfessores()
        {
            InitializeComponent();
        ...
        private void txtNome_Leave(object sender, EventArgs e)
        {
            if (txtNome.Text == "")
            {
                txtNome.Text = "Digite o nome completo do professor";
        ...
        private void mskCpf_Leave(object sender, EventArgs e)
        {
            ...
            {
                mskCpf.Mask = "";
                mskCpf.Text = "Digite o cpf do professor";
                cpfPlaceholder = true;
            }
        }
        ...
        private void mskTelefone_Leave(object sender, EventArgs e)
        {
            ...
            {
                mskTelefone.Mask = "";
                mskTelefone.Text = "Digite o telefone do professor";
        ...
        private void txtEmail_Leave(object sender, EventArgs e)
        {
            if (txtEmail.Text == "")
            {
                txtEmail.Text = "Digite o email do professor";
        ...
        private void txtSenha_Leave(object sender, EventArgs e)
        {
            if (txtSenha.Text == "")
            {
                txtSenha.Text = "Digite a senha do professor";
        ...
        private void mskCep_Leave(object sender, EventArgs e)
        {
            ...
            {
                mskCep.Mask = "";
                mskCep.Text = "Digite o cep do professor";
                cepPlaceholder = true;
            }
        }
        ...
        private void txtRua_Leave(object sender, EventArgs e)
        {
            if (txtRua.Text == "")
            {
                txtRua.Text = "Digite a rua do professor";
                ruaPlaceholder = true;
            }
        }
        ...
        private void txtCidade_Leave(object sender, EventArgs e)
        {
            if (txtCidade.Text == "")
            {
                txtCidade.Text = "Digite a cidade do professor";
        ...
        private void btnAdicionarProfessor_Click(object sender, EventArgs e)
        {
            ...
            if ((txtNome.Text == "" || nomePlaceholder) || (mskCpf.Text.Replace(" ", "").Length < 14 || cpfPlaceholder) ||
                ...
                cboEstado.SelectedIndex == 0 || cboSexo.SelectedIndex == 0)
            {
        ...
        private void CadastrarResult(bool cadastrado)
        {
            ...
            {
                MessageBox.Show("Não foi possível cadastrar o professor, tente novamente mais tarde", "Erro");
                this.Close();
            }
        }
    }
